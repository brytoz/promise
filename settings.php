...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="https://ap.assetsgeniushub.com/user/settings" />
        <link
            rel="shortcut icon"
        ...
        <title>Assets Genius Hub - Settings</title>
    </head>
                        ...
                        <div class="container-fluid">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="wrap-custom-file">
                                                                ...
                                                                <label for="avatar">
                                                                    <img
                                                                        class="upload-icon"
                                                                        src="https://ap.assetsgeniushub.com/assets/global/materials/upload.svg"
                                                                        alt=""
                                                                    />
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="site-card">
                                        <div class="site-card-header">
                                            <h3 class="title">Password Settings</h3>
                                        </div>
                                        <div class="site-card-body">
                                            <?php echo '<form
                                                action="'.updatePassword($username).'"
                                                method="post"
                                            >'; ?>
                                                <div class="progress-steps-form">
                                                    <div class="row">
