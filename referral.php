...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="https://ap.assetsgeniushub.com/user/referral" />
        <link
            rel="shortcut icon"
        ...
        <title>Assets Genius Hub - Referral</title>
    </head>
                                        ...
                                        <div class="single-noti">
                                            ...
                                            >
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="time">42 minutes ago</div>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="single-noti">
                                        ...
                                        <div class="site-card-body">
                                            <div class="referral-link">
                                                ...
                                                <?php referalCount($username); ?>
                                                    peoples are joined by using this URL</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="site-card-header">
                                            ...
                                            <div class="card-header-links">
                                                <span class="card-header-link rounded-pill">
                                                    Referral Profit: <?php getTotalEarnings($username);?> USD</span
                                                >
                                            </div>
                                        </div>
