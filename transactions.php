...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="https://ap.assetsgeniushub.com/user/transactions" />
        <link
            rel="shortcut icon"
        ...
        <title>Assets Genius Hub - Schema Logs</title>
    </head>
                                        ...
                                        <div class="site-card-body">
                                            <div class="site-table">
                                                <div class="table-filter">
                                                    <!-- <div class="filter">
                                                        <form
                                                            action="https://ap.assetsgeniushub.com/user/transactions"
                                                            method="get"
                                                        >
                                                            <div class="search">
                                                                <input
