...
<html lang="en">
    <head>
        ...
        <link rel="canonical" href="https://ap.assetsgeniushub.com/user/deposit" />
        <link
            rel="shortcut icon"
        ...
        <title>Assets Genius Hub - Deposit Now</title>
    </head>
    <body class="dark-theme">
                        ...
                        <div class="single-nav-right">
                            ...
                            <div class="single-right">
                                ...
                                >
                                    ...
                                    <option value="https://ap.assetsgeniushub.com/language-update?name=es">
                                        Spanish
                                    </option>
                                    <option value="https://ap.assetsgeniushub.com/language-update?name=fr">
                                        Franch
                                    </option>
                                </select>
                            </div>
                                    ...
                                    <div class="site-card">
                                        <div class="site-card-header">
                                            ...
                                            <div class="card-header-links">
                                                <a href="deposit-log.php" class="card-header-link">Deposit History</a>
                                            </div>
                                        </div>
                                        <div class="site-card-body">
                                            <div class="progress-steps">
                                                ...
                                                <div class="single-step">
                                                    ...
                                                    <div class="content">
                                                        <h4>Progress</h4>
                                                        <p>Progress to Your Deposit</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="progress-steps-form">
                                                <?php echo '<form  action="'.depositCheck($username).'" method="post" >';?>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 col-md-12" >
                                                            ...
                                                            <select
                                                                ...
                                                                >
                                                                    ...
                                                                    <option value="starter">Starter $1000 - $9999</option>
                                                                    <option value="silver">Silver $10000 - $49999</option>
                                                                    <option value="gold">Gold $50000 - $500000</option>
                                                                    <option value="cannabis">Cannabis $30000 - $20000000</option>
                                                                    <option value="special">Special $20000 - $100000000</option>
                                                                </select>
        ...
        <script>
            ...
            $("#gatewaySelect").on("change", function (e) {
                ...
                $(".manual-row").empty();
                var code = $(this).val();
                var url = "https://ap.assetsgeniushub.com/user/deposit/gateway/:code";
                url = url.replace(":code", code);
                $.get(url, function (data) {
                    globalData = data;
                    $(".charge").text(
                        "Charge " + data.charge + " " + (data.charge_type === "percentage" ? " % " : currency)
                    );
                    $(".min-max").text(
                        "Minimum " +
                    ...
                    if (Number(amount) > 50) {
                        ...
                        var charge =
                            data.charge_type === "percentage" ? calPercentage(amount, data.charge) : data.charge;
                ...
                $("#amount").on("keyup", function (e) {
                    ...
                    var charge =
                        globalData.charge_type === "percentage"
